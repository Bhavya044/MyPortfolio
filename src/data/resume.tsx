...
export const DATA = {
  name: " Bhavya Suri – Full-Stack React & Next.js Developer",
  initials: "BS",
  ...
  navbar: [
    ...
    {
      href: "bhavyasuri.bs23@gmail.com",
      icon: MailIcon,
      label: "Mail me - bhavyasuri.bs23@gmail.com",
      type: "mail",
    },
  ],
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Bhavya044",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/bhavya-suri044",
        navbar: true,
        icon: Icons.linkedin,
      },
    },
  ...
  work: [
    {
      ...
      location: "Zirakpur",
      logoUrl:
        "https://media.licdn.com/dms/image/v2/C4E0BAQFfyzJuJyVtUQ/company-logo_200_200/company-logo_200_200/0/1631365066374/hsrtechnologies_logo?e=1747267200&v=beta&t=x3FV0lokLqtB-ydgKOkPcKJdg9Y94XLSAZgPindOXjU",
  ...
  projects: [
    {
      ...
      links: [
        {
          href: "https://github.com/Bhavya044/Ai-Recipe-Gen?tab=readme-ov-file",
          type: "Source Code",
        },
        { href: "https://ai-recipe-gen-user.vercel.app/", type: "Live Site" },
      ],
      image: "./ai.png",
      description:
    ...
    },
    {
      ...
      active: true,
      image:
        "https://img.freepik.com/free-vector/travel-logo-template_23-2149705428.jpg",
      description:
