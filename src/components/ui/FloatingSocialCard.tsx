...
export default function FloatingSocialCard() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <Card className="bg-neonGreen border border-gray-700 rounded-2xl shadow-lg p-2 backdrop-blur-md transition-transform transform hover:scale-105 duration-300">
        <CardContent className="flex gap-3 justify-center items-center">
          <div className="relative group">
            <Link href="https://github.com/bhavya044" target="_blank" aria-label="GitHub">
          ...
          <div className="relative group">
            <Link href="https://linkedin.com/in/bhavya-suri044" target="_blank" aria-label="LinkedIn">
