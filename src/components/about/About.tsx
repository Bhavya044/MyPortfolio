  ...
  const education = [
    {
      ...
      duration: "2019 - 2023",
      description:
        "Graduated with First Class Honors, focusing on software development and web technologies.",
    },
    {
      degree: "Higher Secondary Education",
      institution: "Dav Public School, Chandigarh",
      duration: "2017 - 2019",
        ...
        <motion.h2
         ...
         $ about me
          ...
          <p className="leading-relaxed text-lg">
            ...
            {databaseSkills.join(", ")}
            <br />
            <span className="text-pink-400">&gt; - Tools & Testing:</span>{" "}
            {toolsSkills.join(", ")}
            <br />
            <span className="text-white">
          ...
          <div className="leading-relaxed text-lg">
            ...
            {education.map((edu, index) => (
              <div key={index} className="mt-4">
                <h3 className="text-neonGreen font-semibold text-xl">
                  {edu.degree}
                </h3>
      ...
      <div className="flex flex-wrap gap-6 text-xl mt-6 justify-center mt-3">
            ...
            >
              <div className="group flex items-center gap-3 p-4 rounded-2xl bg-black/30 backdrop-blur-md shadow-lg hover:shadow-yellow-500 transition-all duration-300 hover:scale-105">
                <SiLeetcode
                  className="text-white group-hover:text-yellow-500 transition-all duration-300"
                  size={24}
                />
                <span className="text-white group-hover:text-yellow-500 hidden sm:block">
                  LeetCode
                </span>
              </div>
            </Link> */}
