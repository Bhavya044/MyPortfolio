      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="flex flex-col gap-6">
          ...
          <p className="leading-relaxed text-base">
            ...
            <span className="text-white">&gt; Constantly exploring the latest tech trends.</span><br />
            <span className="text-white">&gt; 📧 Email: <a href="mailto:bhavyasuri.bs23@gmail.com" className="text-neonGreen hover:underline">bhavyasuri.bs23@gmail.com</a></span><br />
            <span className="text-white">&gt; 📞 Phone: <a href="tel:+916283315811" className="text-neonGreen hover:underline">+91 6283315811</a></span>
          </p>
